...
<p align="center">
  ...
  <img alt="Tests" src="https://img.shields.io/badge/tests-862%20passing-brightgreen" />
</p>
...
- **Delta Scan** — what changed since your last scan, continuous review
- **Exception management** — approve known issues with reason, approver, and expiry. Track, revoke, extend. Audit-ready.
...
**Pro** — adds Node.js, multi-ecosystem scanning, exception management, online OSV lookup, license compatibility analysis, vulnerability triage, Delta Scan. Answers: *how bad, what do I fix first, and what have I already approved?* One-time purchase via Microsoft Store.
